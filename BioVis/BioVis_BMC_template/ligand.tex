...
\begin{figure}[tb]
  ...
  The scatterplots showing the evolution of the distance from the active site for all three ligands over time:
...
In this particular case the biochemists were able to easily estimate the ability of the active site to bind TCP--296 and TCP--294 directly from the distance scatterplots (see Figure~\ref{fig:tcp3_distances}).
...
\begin{figure}[tb]
  ...
  Scatterplot showing the relationship between the distance from the active site and the stuckness of the TCP-296 ligand. {\color{red} what about merging Fig15 and this one?}
  }
\end{figure}

Finally, as can be seen in the distance scatterplot (see Figure~\ref{fig:tcp3_distances}), both TCP--294 and TCP--296 entered the protein active site during a short period of time and never left it afterwards.
