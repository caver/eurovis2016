...
Here the biochemist can immediately see that the whole simulation consist basically from two parts (divided by yellow color signalizing that tunnel was moving near the protein surface).
