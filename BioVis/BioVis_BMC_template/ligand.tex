...
This simple 1D representation encodes different routes of the ligand -- red color highlights the parts of the trajectory where the ligand is inside the protein, white color encodes the situation when the ligand is outside the protein, blue denotes for the situation when the ligand is close to the protein surface.
Orange color shows the time portions when the ligand was close to the active site.
