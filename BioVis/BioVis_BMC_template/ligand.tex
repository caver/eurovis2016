...
For instance, obviously there is a spike in the distance of TCP--296 from the active site around time step 30.000. 
This corresponds to the time when the TCP--294 started to head towards the active site.
